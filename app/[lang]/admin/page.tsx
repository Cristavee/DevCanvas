...
import { Users, FileCode, ShieldAlert, BarChart3, type LucideIcon } from "lucide-react";
...
export default async function AdminPage({ params: { lang } }: { params: { lang: string } }) {
  ...
  let projects: DemoProject[] = DEMO_PROJECTS;
  let totalUsers = 4;
  let totalProjects = 8;
  ...
  const RECENT_DEVS = ["Sarah Chen", "Alex Rivera", "Marcus Wei", "Priya Sharma"];
